      ...
      {open && (
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: '0 28px 70px rgba(0,0,0,0.6), 0 0 60px rgba(34,197,94,0.05)',
          }}
        >
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '6px' }}>
            {SERVICES.map((s) => (
              ...
              >
                <span
                  style={{
                    flexShrink: 0, width: '34px', height: '34px', borderRadius: 'var(--radius-sm)',
                    background: 'rgba(34,197,94,0.08)', border: '1px solid rgba(34,197,94,0.16)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    color: 'var(--color-primary)', fontSize: '0.95rem',
                  }}
                >
                  {s.icon}
                </span>
                <span>
                  <span
                    style={{
                      display: 'block', color: '#fff', fontSize: '0.875rem',
                      fontWeight: 600, marginBottom: '4px', lineHeight: 1.35,
                      fontFamily: 'var(--font-display)',
                    }}
                  >
                    {s.shortTitle}
                  </span>
                  <span style={{ display: 'block', color: 'rgba(255,255,255,0.48)', fontSize: '0.7813rem', lineHeight: 1.5 }}>
                    {s.tagline}
                  </span>
                </span>
              </Link>
          ...
          >
            <span style={{ fontSize: '0.8125rem', color: 'rgba(255,255,255,0.48)' }}>
