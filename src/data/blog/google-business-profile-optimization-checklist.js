export default {
  ...
  title: 'Google Business Profile Optimisation: The 18-Point Checklist for Local Businesses',
  ...
  featured: true,
  related: ['how-to-choose-web-development-company', 'website-development-cost-india', 'restaurant-qr-menu-system-guide'],
  faqs: [
    {
      q: 'How long does it take to rank on Google Maps?',
      a: 'A newly verified profile usually starts appearing for low-competition searches within 2–4 weeks. Competitive local terms take 3–6 months of consistent activity, reviews and NAP consistency.',
    },
    {
      q: 'What are the main Google Maps ranking factors?',
      a: 'Google states three: relevance (how well your profile matches the search), distance (proximity to the searcher), and prominence (reviews, citations, web presence and overall authority). Categories, NAP consistency and review velocity are the levers you can actually control.',
    },
    {
    ...
    },
    {
      ...
      a: 'Ask consistently and make it frictionless. Use your profile’s short review link, send it by WhatsApp immediately after a positive interaction, and reply to every review. Steady review velocity matters more than a sudden burst.',
    },
  ],
  content: [
    ...
    { type: 'p', text: 'Name, Address, Phone. These three must be byte-for-byte identical across your Google profile, your website, Justdial, IndiaMART, Facebook, and every directory you appear in. "Shop 4" versus "Shop No. 4" versus "Shop-4" reads as three different businesses to Google’s entity matching.' },
    {
      type: 'callout',
      title: 'Do this now',
      text: 'Write your NAP once in a text file exactly as it should appear. Copy from that file every time you fill a directory form. Never retype it.',
    },

    { type: 'h3', text: '5. Do not keyword-stuff the business name' },
    { type: 'p', text: 'Adding "Best Website Development Company" to your business name violates Google’s guidelines, is easily reported by competitors, and can get the listing suspended. Use your real registered business name. Relevance comes from categories and services, not from the name field.' },
    ...
    { type: 'h3', text: '11. Upload a proper photo set' },
    { type: 'p', text: 'Listings with photos receive substantially more direction requests and clicks than those without. Upload at least:' },
    {
      type: 'ul',
      items: [
    ...
    { type: 'p', text: 'Use real photographs. Stock imagery is visible from a distance and undermines the trust the profile is supposed to build.' },

    { type: 'h3', text: '12. Keep adding photos regularly' },
    { type: 'p', text: 'A profile with photos uploaded every month reads as an active business. One with a final upload from 2023 reads as possibly closed. Two or three new photos a month is enough.' },

    { type: 'h2', text: 'Reviews: the strongest prominence signal you control' },

    { type: 'h3', text: '13. Build a repeatable review request habit' },
    { type: 'p', text: 'Get your short review link from the profile dashboard. Send it by WhatsApp within a few hours of completing good work, while satisfaction is highest. A short personal message outperforms any automated system in India by a wide margin.' },

    { type: 'h3', text: '14. Prioritise steady velocity over volume' },
    ...
    { type: 'p', text: 'Reply to positive reviews briefly and specifically. Reply to negative reviews calmly, publicly, and with a route to resolution. Prospective customers read the response far more carefully than the complaint — a professional reply to a bad review often builds more trust than a five-star rating.' },
    {
      type: 'callout',
      title: 'Never do this',
      text: 'Do not buy reviews. Google’s detection has improved sharply, penalties hit the whole profile, and Indian consumers are unusually good at spotting fake review patterns.',
    },
    ...
    {
      type: 'table',
      head: ['Timeframe', 'What typically happens'],
      rows: [
        ['Week 1–2', 'Verification completes, profile becomes fully editable and starts showing'],
        ['Week 2–4', 'Appearances for branded and low-competition searches'],
        ['Month 2–3', 'Movement on mid-competition local terms as reviews accumulate'],
    ...
    { type: 'h2', text: 'The five mistakes that cause most failures' },
    {
      type: 'ol',
      items: [
        'Keyword-stuffing the business name and risking suspension',
        'Different addresses or phone numbers across directories',
        'A wrong or overly broad primary category',
        'No reviews, or reviews nobody ever replies to',
